...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Frequency_range = Range(-samp_rate/2, samp_rate/2, 100, 1500, 200)
        ...
        self._Amp_range = Range(0, 5, 1, 0.1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, Frequency, Amp, 0, 0)
